...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "IntellectFlow Reviews — Automate Everything. Miss Nothing." },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "IntellectFlow Reviews" },
      {
        ...
        content:
          "AI-assisted Google review collection for local businesses. Automate everything, miss nothing.",
      },
